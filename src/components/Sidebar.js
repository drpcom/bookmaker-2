...
const Sidebar = () => {
    return (
        <div className="md:w-2/5 bg-violet-300 h-full hidden md:flex md:flex-col md:h-auto spec:h-full">
          ...
          <div className='flex flex-row justify-center flex-wrap ml-4 xl:justify-start'>
            <button className='bg-emerald-50 rounded w-32 h-36 spec:w-44 spec:h-48 shadow-md shadow-slate-700/50 m-2'>
