    ...
    return (
        ...
        <div className={open ? "md:w-2/5 bg-violet-300 dark:bg-[#2e2e37] h-fit min-h-screen hidden md:flex md:flex-col mb-16" : "hidden"}>
          <div className="flex flex-row items-center h-12 mt-4 mb-4 ml-2 pl-4 pr-4 xl:self-center">
            ...
            <div className={clickedViewChange ? 'flex flex-row flex-wrap ml-6 xl:justify-center mr-6' : 'flex flex-row flex-wrap ml-4 xl:justify-center'}>
            ...
            : <div className="flex flex-col text-center h-[69vh] items-center justify-center text-[#9191be] dark:text-zinc-500">
                <svg className="w-48 h-48 mb-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" /></svg>
