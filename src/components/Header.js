      ...
      <div className="h-2/3 pt-2 pb-2 bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-200 dark:from-[#2e2e37]  dark:to-zinc-700">
        <div className="w-full h-full flex flex-wrap justify-between">
          <div className="flex flex-row">
            <div className="flex text-lg z-10 justify-around w-32">
              ...
              <div className="self-center">
                <button
                  ...
                  data-tooltip-target="open-tooltip"
                  type="button"
                >
                  <UploadBtn />
                </button>
            ...
            <div className="text-slate-100 text-2xl mr-4 ml-4 hidden sm:flex">
              ||
            </div>
            <div className="flex text-lg z-10 justify-around w-40">
              <div>
                <button
                  ...
                  data-tooltip-target="zoom-in-tooltip"
                  type="button"
                >
                  <svg
              ...
              <div>
                <button
                  ...
                  data-tooltip-target="zoom-out-tooltip"
                  type="button"
                >
                  <svg
                    className="w-7 h-7 text-slate-600 dark:text-sky-300"
              ...
              <div>
                ...
                >
                  {open ? (
                    <svg
                      className="w-7 h-7 text-slate-600 dark:text-sky-300 hidden md:flex"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
          ...
          >
            {clicked ? (
              <svg
                className={
                  selectedDoc
                    ? "w-7 h-7 text-slate-600 dark:text-green-400 mr-2"
                    : "w-7 h-7 text-slate-600 dark:text-green-400 mr-2 animate-bounce"
                }
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
