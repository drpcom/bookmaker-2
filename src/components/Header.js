          ...
          <div className='flex flex-row'>
            <div className='flex text-lg z-10 justify-around w-32'>
              <div>
                ...
                <div id="create-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                  New Document
              ...
              <div className='self-center'>
                ...
                <div id="open-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                  Open
                <div className='tooltip-arrow' data-popper-arrow></div>
                </div>
              </div>
              <div className='self-center'>
                ...
                <div id="save-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                  Save
                <div className='tooltip-arrow' data-popper-arrow></div>
                </div>
              </div>
            ...
            <div className='flex text-lg z-10 justify-around w-40'>
                <div>
                  ...
                  <div id="zoom-in-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                    Zoom In
                  <div className='tooltip-arrow' data-popper-arrow></div>
                </div>
                </div>
                <div>
                  ...
                  <div id="zoom-out-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                    Zoom Out
                  <div className='tooltip-arrow' data-popper-arrow></div>
                </div>
                </div>
              ...
              <div>
                ...
                <div id="collapse-tooltip" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                    Collapse Sidebar
                  <div className='tooltip-arrow' data-popper-arrow></div>
                </div>
              </div>
