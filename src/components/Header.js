        ...
        <div className="w-full h-full flex flex-wrap justify-between">
          <div className='flex flex-row'>
            ...
            <div className='flex text-lg z-10 justify-around w-40'>
                <div>
                  <button onClick={() => handleZoomIn()} data-tooltip-target="zoom-in-tooltip" type="button">
                ...
                <div>
                  <button onClick={() => handleZoomOut()} data-tooltip-target="zoom-out-tooltip" type="button">
