...
const DarkMode = () => {
    ...
    return (
        ...
        <div id="dark-mode" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition duration-300 tooltip dark:bg-gray-700">
            Dark Mode
        ...
        <div id="light-mode" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition duration-300 tooltip dark:bg-gray-700">
            Light Mode
            <div className='tooltip-arrow' data-popper-arrow></div>
        </div>
        </>)
