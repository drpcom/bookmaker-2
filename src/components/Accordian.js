...
<div className="collapse" id="collapseExample">
  ...
  <div className='flex flex-row xl:justify-start'>
            <button className='bg-emerald-50 dark:bg-zinc-700 rounded w-32 h-36 min-w-[128px] lg:w-44 lg:h-48 shadow-md shadow-slate-700/50 m-2 flex flex-col p-2 lg:p-3 hover:animate-pulse'>
