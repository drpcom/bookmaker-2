...
export default function Create() {
    ...
    return (
        <>
            <button onClick={NewNote} className="flex flex-row text-slate-100 items-center bg-[#7a7ab8] dark:bg-sky-400 rounded-sm h-full w-12 justify-center" data-tooltip-target="create-tooltip" type="button">
